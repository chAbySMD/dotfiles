...
map("n", "<leader>l", "<cmd>w<CR>", { desc = "Save" })
...
map("n", "<leader>qw", "<cmd>Trouble workspace_diagnostics toggle<CR>", { desc = "Open Workspace Trouble" })
map("n", "<leader>qd", "<cmd>Trouble document_diagnostics toggle<CR>", { desc = "Open Document Trouble" })
map("n", "<leader>qq", "<cmd>Trouble quickfix toggle<CR>", { desc = "Open Quickfix" })
